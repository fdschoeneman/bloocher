module HipsterIpsum
  ...
  def intro 
    [
      "Remarkable","Juicy","Desperate","Serviceable","Generous","Glassy",
      "Blunt","Sturdy","Elegant","Lean","Spare","Simple"
      ...
      "Finely balanced","Premature","A firm, full textured",
      "Fully refined","Unnatural","Shows some rustic","Historic","Classic","Crisp",
  ...
  def intmodifier
    [
      ...
      "yet paradoxically", "nevertheless", "yet oxymoronically"
    ].sample
  end
  ...
  def varietal 
    [
      ...
      "Gewurztraminer","Marsanne","Pinot Gris","Voignier","Sauvingnon Blanc",
      "Semillon","Rose","Sparkler","Port","Dessert wine"
    ].sample
  end   

  def adjective
    [  
      "sassy","desperate","longingly elegant","sad","hopeless","intense","focused",
      "meandering","melancholy","putrid","yellowed","arcane","acidic monster",
      ...
      "acidic","overcooked","understated","fleshy","extra-ripe","zelous",
      "underdone","oaky","over-oaked","american-oaked","french-oaked","musty",
      "soggy","fat","wicked","whimsical","oily","astounding","corpulent",
      "second-rate","boggling","unripe","overcooked","sugary","over-the-top"
    ].sample
  end
  ...
  def adverb
    [ 
      ...
      "Forcefully bites you with","Reminds one of"
    ].sample
  end
  ...
  def flavor
    [
      ...
      "cardboard"."salted beef","beef","gatorade but not in a bad way"
      ...
      "shallot","fois gras","kalamata olive","celery","fig","pineapple","salad",
